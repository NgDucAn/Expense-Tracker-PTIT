...
import com.duongpt.expensetracker.features.money.domain.usecases.CheckCategoriesExistUseCase
import com.duongpt.expensetracker.features.money.domain.usecases.InsertCategoriesUseCase
    ...
    private fun loadCategoriesFromJson() {
        viewModelScope.launch {
            try {
                ...
                val allCategories =
                    mutableListOf<com.duongpt.expensetracker.features.money.domain.model.Category>()
