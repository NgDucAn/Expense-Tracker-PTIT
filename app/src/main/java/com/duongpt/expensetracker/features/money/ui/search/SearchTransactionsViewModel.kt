package com.duongpt.expensetracker.features.money.ui.search
...
import com.duongpt.expensetracker.features.money.domain.usecases.SearchFailure
...
class SearchTransactionsViewModel @Inject constructor(
     ...
     */
    private fun handleSearchFailure(failure: com.duongpt.expensetracker.core.failure.Failure) {
