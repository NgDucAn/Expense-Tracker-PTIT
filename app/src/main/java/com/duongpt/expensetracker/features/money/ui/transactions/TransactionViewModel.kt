...
import com.duongpt.expensetracker.utils.createTotalWallet
...
class TransactionViewModel @Inject constructor(
     ...
     */
    private fun handleReactiveTransactionResult(result: com.duongpt.expensetracker.core.functional.Either<com.duongpt.expensetracker.core.failure.Failure, kotlinx.coroutines.flow.Flow<List<DailyTransactions>>>) {
                        result.fold(
                            { failure ->
     ...
     */
    private fun handleTransactionResult(result: com.duongpt.expensetracker.core.functional.Either<com.duongpt.expensetracker.core.failure.Failure, List<DailyTransactions>>) {
                                                result.fold(
                                                    { failure ->
