...
class BudgetRepositoryImpl @Inject constructor(
    ...
    override suspend fun getBudgetById(budgetId: Int): Budget? {
        ...
        val wallet = if (budgetEntity.walletId == null) {
            ...
            val allWallets = allEntities.map { com.duongpt.expensetracker.features.money.domain.model.Wallet.fromEntity(it) }
            ...
            com.duongpt.expensetracker.features.money.domain.model.Wallet(
                id = -1,
            ...
            com.duongpt.expensetracker.features.money.domain.model.Wallet.fromEntity(entity)
        }
        ...
        return Budget(
            ...
            category = Category(
                ...
                type = when (categoryEntity.type) {
                    1 -> com.duongpt.expensetracker.features.money.domain.model.CategoryType.INCOME
                    2 -> com.duongpt.expensetracker.features.money.domain.model.CategoryType.EXPENSE
                    3 -> com.duongpt.expensetracker.features.money.domain.model.CategoryType.DEBT_LOAN
                    else -> com.duongpt.expensetracker.features.money.domain.model.CategoryType.UNKNOWN
                },
