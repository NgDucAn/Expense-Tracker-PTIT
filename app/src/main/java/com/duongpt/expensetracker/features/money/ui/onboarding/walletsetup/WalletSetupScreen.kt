package com.duongpt.expensetracker.features.money.ui.onboarding.walletsetup
...
fun WalletSetupScreen(
    ...
    savedStateHandle?.getLiveData<com.duongpt.expensetracker.features.money.domain.model.Currency>("selected_currency")
        ?.observe(lifecycleOwner) { currency ->
            viewModel.processIntent(WalletSetupIntent.CurrencySelected(currency))
            savedStateHandle.remove<com.duongpt.expensetracker.features.money.domain.model.Currency>("selected_currency")
        }
...
fun WalletSetupScreenContentPreview() {
    ExpenseTrackerTheme {
        val sampleCurrency = com.duongpt.expensetracker.features.money.domain.model.Currency(
            id = 1,
