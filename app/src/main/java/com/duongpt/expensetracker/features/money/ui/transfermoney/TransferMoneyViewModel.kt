package com.duongpt.expensetracker.features.money.ui.transfermoney
...
import com.duongpt.expensetracker.features.money.domain.usecases.TransferMoneyParams
...
class TransferMoneyViewModel @Inject constructor(
    ...
    private fun convertCurrency() {
        ...
        if (fromCurrencyCode == toCurrencyCode) {
            val formattedAmount = com.duongpt.expensetracker.utils.formatAmount(state.amount, true)
            _viewState.value = _viewState.value.copy(
        ...
        viewModelScope.launch {
            try {
                ...
                if (convertedAmount != null && originalRate != null) {
                    ...
                    val displayExchangeRate = "1 $fromCurrencyCode = ${com.duongpt.expensetracker.utils.formatAmount(originalRate, true)} $toCurrencyCode"
                    
                    // Format the converted amount
                    val formattedToAmount = com.duongpt.expensetracker.utils.formatAmount(convertedAmount, true)
